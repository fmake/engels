...
function addFormBaner(){
	...
	$str_add_baner = "<div class=\"line_baner_add\"><input title=\"Название банера\" type=\"text\" name=\"baner[new][caption][]\" style=\"width:200px;\"/><input title=\"Загрузка банера\" type=\"file\" name=\"baner_new_picture[]\" /><select title=\"Тип банера\" name=\"baner[new][id_type][]\">".$select_type_options."</select><input title=\"Цена расхода банера\" type=\"text\" name=\"baner[new][price][]\" style=\"width:80px;\"/><input title=\"Кол.во показов банера\" type=\"text\" name=\"baner[new][max_count_view][]\"  style=\"width:80px;\"/><input title=\"Ссылка на банер\" type=\"text\" name=\"baner[new][url][]\" style=\"width:150px;\"/><span class=\"delete_baner\" style=\"color:red;cursor:pointer;\">удалить</span><input type=\"submit\"/></div>";
