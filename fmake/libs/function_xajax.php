...
function formFoto($values){
	...
	if (md5($code) != $_SESSION['code_foto']){
		...
		$script = "$(\"#form_foto_for_comments .error\").html(\"\");$(\"#form_foto_for_comments .captcha\").val(\"\");$(\"#form_foto_for_comments .name\").val(\"\");$(\"#form_foto_for_comments .sucless\").html('Ваше сообщение отправлено.'');$(\"#form_foto_for_comments .error\").html('');";
