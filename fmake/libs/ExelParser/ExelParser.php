...
//		 for ($i=0;$i<sizeof($ansArray);$i++){
//			for ($j=0;$j<sizeof($ansArray[$i]);$j++){
//				echo $ansArray[$i][$j]."  ";
//			}	
//			echo "<br />";
//		}

		//$this->printAr($ansArray);
		//echo $this->unhtmlentities($ansArray[0][0]);
		return $ansArray;
	}
...
//echo print_r($mypars->getQuery($arr));
//echo print_r($arr,1);
//echo html_entity_decode(($arr[0][0]),ENT_QUOTES,cp1251);;

//echo unhtmlentities($arr[0][0]);
