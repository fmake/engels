...
(function ($, document, window) {
	...
	defaults = {
		...
		next: "Вперед",
		close: "Закрыть",
		xhrError: "Этот контент не удалось загрузить.",
	...
	publicMethod.prep = function (object) {
		...
		function getHeight() {
			...
			settings.h = $loaded.height();
			settings.h = settings.mh < settings.h ? settings.h : settings.mh;
			return settings.h;
		}
