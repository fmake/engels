$(document).ready(function(){
	...
	$(".show").colorbox({
        ...
        onComplete: function(){xajax_htmlforcolorbox($(this).attr('idrel')); setTimeout('$.colorbox.resize()', 100);setTimeout("$('input.fieldfocus,textarea.fieldfocus').fieldFocus();", 400)}, 
