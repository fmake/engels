...
$project_categories = $absitem->getCatAsTree($id_page_modul);
...
$globalTemplateParam->set('categories', $project_categories);
    ...
    default:
        switch ($request->action) {
            ...
            case 'insert': // Новый
				...
				if(!$_POST['parent']) $_POST['parent'] = $id_page_modul;
		...
		if($filters){
			//echo 'qq';
			$items = $absitem->getByPageAdminFilter($filters,$id_page_modul, $limit, $page,"a.`file` = 'item_project'");
			$count = $absitem->getByPageCountAdminFilter($filters,$id_page_modul,$id_page_modul,"a.`file` = 'item_project'");
		}else{
			$items = $absitem->getByPageAdmin($id_page_modul, $limit, $page,"a.`file` = 'item_project'");
			$count = $absitem->getByPageCountAdmin($id_page_modul,$id_page_modul,"a.`file` = 'item_project'");
		}
		//printAr($items);
