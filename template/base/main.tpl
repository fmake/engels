		...
		<div id="block_news">
			<div class="page-container">
				...
				<div id="tape">
					...
					<div class="nav">
						<ul>
							<li><a href="#" onclick="xajax_TapeWaveTab(1); return false;"><span><span><span>Энгельс</span></span></span></a></li>
							<li><a href="#" onclick="xajax_TapeWaveTab(2); return false;"><span><span><span>Саратов</span></span></span></a></li>
							<li class="active" ><a href="#" onclick="xajax_TapeWaveTab(0); return false;"><span><span><span>Все новости</span></span></span></a></li>
						</ul>
					</div>
					<div class="cl"></div>
