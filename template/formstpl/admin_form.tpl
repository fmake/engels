<FORM id='mainform' name='{$form->formName}' action='{$form->formAction}' method='{$form->formMethod}' enctype='{$form->formEnctype}'>
		...
		foreach ($form->elements as $id=>$elements){
			switch($elements->type){
				...
				case 'SUBMIT':
					...
					$input = "<button onclick='javascript: document.getElementById(\"mainform\").submit()' class='fmk-button-admin f10'><div><div>";
