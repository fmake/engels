...
[[if content]]
	...
	[[if pages]]
		<div class="pager" >
		[[for i in 1..pages]]
			<span><a href="/admin/index.php?modul={request.modul}[[if request.id_content]]&id_content={request.id_content}[[endif]][[if request.mod]]&mod={request.mod}[[endif]]&page={i}" [[if i==page ]]class="active"[[endif]] title="Страница {i}" >{i}</a></span>  
		[[endfor]]
		</div>
	[[endif]]
	[[ if items ]]
