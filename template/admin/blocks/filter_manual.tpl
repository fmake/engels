			...
			<li>
				<select name="filter[parent]">
					...
					[[for item in categories]]
						<option style="[[if item.level == 3]]padding-left:40px;[[elseif item.level == 2]]padding-left:20px;[[else]][[endif]]" value="{item.id}" [[if filters.parent == item.id]]selected[[endif]]>{item.caption}</option>
					[[endfor]]
				<select>
			</li>
